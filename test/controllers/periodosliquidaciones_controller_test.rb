...
class PeriodosliquidacionesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create periodosliquidacion" do
    assert_difference('Periodosliquidacion.count') do
      post periodosliquidaciones_url, params: { periodosliquidacion: { estado: @periodosliquidacion.estado, fin: @periodosliquidacion.fin, inicio: @periodosliquidacion.inicio, periodo: @periodosliquidacion.periodo } }
    end
  ...
  test "should update periodosliquidacion" do
    patch periodosliquidacion_url(@periodosliquidacion), params: { periodosliquidacion: { estado: @periodosliquidacion.estado, fin: @periodosliquidacion.fin, inicio: @periodosliquidacion.inicio, periodo: @periodosliquidacion.periodo } }
