...
class PruebasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prueba" do
    assert_difference('Prueba.count') do
      post pruebas_url, params: { prueba: { edad: @prueba.edad, identificacion: @prueba.identificacion, nombre: @prueba.nombre } }
    end
  ...
  test "should update prueba" do
    patch prueba_url(@prueba), params: { prueba: { edad: @prueba.edad, identificacion: @prueba.identificacion, nombre: @prueba.nombre } }
