...
class CategoriasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categoria" do
    assert_difference('Categoria.count') do
      post categorias_url, params: { categoria: { codigo: @categoria.codigo, codigo_nuevo: @categoria.codigo_nuevo, nombre: @categoria.nombre, tipo_servicio: @categoria.tipo_servicio } }
    end
  ...
  test "should update categoria" do
    patch categoria_url(@categoria), params: { categoria: { codigo: @categoria.codigo, codigo_nuevo: @categoria.codigo_nuevo, nombre: @categoria.nombre, tipo_servicio: @categoria.tipo_servicio } }
