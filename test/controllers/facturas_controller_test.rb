...
class FacturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post facturas_url, params: { factura: { categoria_id: @factura.categoria_id, empresa_id: @factura.empresa_id, estado: @factura.estado, nro_factura: @factura.nro_factura, observacion: @factura.observacion, persona_id: @factura.persona_id, personastramite_id: @factura.personastramite_id, tipostramite_id: @factura.tipostramite_id, user_anula: @factura.user_anula, user_id: @factura.user_id, valor: @factura.valor } }
    end
