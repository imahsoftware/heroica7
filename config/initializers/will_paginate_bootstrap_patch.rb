# will_paginate-bootstrap 1.0.2 usa la firma antigua prepare(collection, options, template)
# will_paginate 3.2+ cambió a prepare(collection, options) con template via accessor.
# Este patch actualiza el renderer para compatibilidad.
